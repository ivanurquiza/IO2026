"""
Script 11: Ejercicio 4c. Costos marginales bajo Bertrand multiproducto.
...
Correr:  python code/11_blp_costos.py
"""
...
# ---------- costos marginales por Bertrand multiproducto ---------------
# compute_costs usa firm_ids (las 4 marcas madre) para construir la
# matriz de propiedad e invertir el sistema de primer orden.
costo_blp = res_blp.compute_costs(market_id=MERCADO).flatten()
costo_logit = res_logit.compute_costs(market_id=MERCADO).flatten()
